...
JiU is an F13 WKL TKL mechanical keyboard designed by XV.KB. It's inspiration was based on [JiU](https://kpop.fandom.com/wiki/JiU_(Dreamcatcher)) from [Dreamcatcher](https://en.wikipedia.org/wiki/Dreamcatcher_(group)). To keep up with updates about board and other boards, join my [discord](https://discord.gg/cFghg3fnHT).
